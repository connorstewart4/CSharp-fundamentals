...
// Returns false because they have differen addresses in memory. If you were to compare something like this, you would need to compare the exact items within the list (down with a loop).
