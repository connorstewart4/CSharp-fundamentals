...
/*
    We define the type with teh square brackets. The curly brackets will detail the information within that array. Arrays do have a fixed size determined on how they are created.

    Targeting index within an arra, we always start with position zero.
*/
...
System.Console.WriteLine(firstInFirstOut.Peek()); //Peek() is a method that allows us to view what item is in queue.
firstInFirstOut.Dequeue(); // We are using this method to remoce the item currently in the first position.
